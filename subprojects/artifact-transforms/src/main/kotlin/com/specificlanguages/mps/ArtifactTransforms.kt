...
/**
 * Registers [UnzipMps] and [UnzipRunnableMps] artifact transforms for transforming `artifactType = zip`
 * ([UNZIP_MPS_FROM_ARTIFACT_TYPE]) into `artifactType = unzipped-mps-distribution` ([UNZIP_MPS_TO_ARTIFACT_TYPE]) and
 * `artifactType =unzipped-runnable-mps-distribution` ([UNZIP_MPS_TO_RUNNABLE_ARTIFACT_TYPE]) respectively.
 */
